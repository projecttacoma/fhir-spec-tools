...
const searchParameterPath = path.resolve(
  path.join(__dirname, "../fhir/search-parameters.json")
);
const outputPath = path.resolve(
  path.join(__dirname, "../data/dateSearchParameters.ts")
);
