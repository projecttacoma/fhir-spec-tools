export const systemMap: Record<string, string> = {
  ...
  "http://terminology.hl7.org/CodeSystem/v3-ActMood": "ActMood",
  "http://terminology.hl7.org/CodeSystem/v3-ActPriority": "ActPriority",
  "http://terminology.hl7.org/CodeSystem/v3-ActReason": "ActReason",
  "http://terminology.hl7.org/CodeSystem/v3-ActRelationshipType":
    "ActRelationshipType",
  "http://terminology.hl7.org/CodeSystem/v3-ActStatus": "ActStatus",
  ...
  "http://terminology.hl7.org/CodeSystem/v2-0001": "AdministrativeSex",
  ...
  "http://terminology.hl7.org/CodeSystem/v2-0112": "DischargeDisposition",
  "http://terminology.hl7.org/CodeSystem/v3-EntityNamePartQualifier":
    "EntityNamePartQualifier",
  "http://terminology.hl7.org/CodeSystem/v3-EntityNameUse": "EntityNameUse",
  ...
  "http://terminology.hl7.org/CodeSystem/v3-LivingArrangement":
    "LivingArrangement",
  "http://www.nlm.nih.gov/research/umls/MED-RT": "MED-RT",
  "http://terminology.hl7.org/CodeSystem/v3-MaritalStatus": "MaritalStatus",
  "http://ncicb.nci.nih.gov/xml/owl/EVS/Thesaurus.owl": "NCI",
  "http://hl7.org/fhir/ndfrt": "NDFRT",
  "http://nucc.org/provider-taxonomy": "HealthCareProviderTaxonomy",
  ...
  "http://terminology.hl7.org/CodeSystem/v3-RoleClass": "RoleClass",
  "http://terminology.hl7.org/CodeSystem/v3-RoleCode": "RoleCode",
  "http://terminology.hl7.org/CodeSystem/v3-RoleStatus": "RoleStatus",
  "http://snomed.info/sct": "SNOMEDCT",
  "https://nahdo.org/sopt": "SOP",
  "http://unitsofmeasure.org": "UCUM",
  "http://www.nlm.nih.gov/research/umls": "UMLS",
  "http://fdasis.nlm.nih.gov": "UNII",
  "http://terminology.hl7.org/CodeSystem/v3-MediaType": "MediaType",
};
